...
export default {
  ...
  startingPoint: [new Vec2D(-60, 10), new Vec2D(60, 10), new Vec2D(-20, 10), new Vec2D(20, 10),new Vec2D(-45, 10), new Vec2D(45, 10), new Vec2D(-35, 10), new Vec2D(35, 10)],
  startingFace: [1, -1, 1, -1,,1,-1,1,-1],
  respawnPoints: [new Vec2D(16, 45), new Vec2D(-16, 45), new Vec2D(50, 45), new Vec2D(-50, 45),new Vec2D(28, 45), new Vec2D(-28, 45), new Vec2D(35, 45), new Vec2D(-35, 45)],
  respawnFace: [1, -1, 1, -1,1,-1,1,-1],
